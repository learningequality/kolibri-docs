...
.. note:: The following issues are quite common on a Raspberry Pi:
  ...
  * **Storage space** is often a scarce. If you have a USB source for additional storage, you can use a ``kolibri`` management command or create your own symbolic links to have the data folder located elsewhere.
