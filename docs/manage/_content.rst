...
11. To add more learning resources from a channel that you previously imported content from, click **Options**, select **Import more**, and repeat the selection procedure from step 3. 
